...
# ssh
alias ssh-ap="ssh forge@159.89.80.230"
alias ssh-ap-staging="ssh forge@142.93.203.171"
alias ssh-ap-uat="ssh forge@159.89.235.165"
...
export PATH=$HOME/Sites/spark-installer:$PATH
